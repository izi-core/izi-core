...
from izi.test.factories import Member

from izi.apps.dashboard.widgets import RelatedFieldWidgetWrapper


@override_settings(ROOT_URLCONF='izi.test.factories.urls')
