...
from izi.core.loading import AppNotFoundError, get_class
from izi.views.decorators import check_permissions

logger = logging.getLogger('izi.dashboard')
...
def default_access_fn(user, url_name, url_args=None, url_kwargs=None):
    ...
    and those assumptions will only hold true if the standard IZI layout
    is followed.
    ...
    exception = ImproperlyConfigured(
        "Please follow IZI's default dashboard app layout or set a "
        "custom access_fn")
    ...
    try:
        ...
        # In IZI 1.5 this exception was silently ignored which made debugging
    ...
    # string (e.g. 'izi.apps.dashboard.catalogue.views') into an app
