...
from izi.apps.customer import history
from izi.core.compat import get_user_model
from izi.templatetags.history_tags import get_back_button
...
class TestAUserWhoLogsOut(WebTestCase):
    ...
    def test_has_their_cookies_deleted_on_logout(self):
        ...
        self.assertTrue((COOKIE_NAME not in response.test_app.cookies)
                        or not self.app.cookies.get('izi_recently_viewed_products', None))
