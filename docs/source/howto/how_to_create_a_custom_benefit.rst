...
IZI ships with several offer benefits for building offers.  There are three
types:
...
IZI also lets you create your own benefits for use in offers.  
...
A benefit class must be a proxy class and have the following methods::
    ...
    class MyCustomBenefit(models.Benefit):
        ...
        def apply(self, basket, condition, offer):
            ...
            ``izi.apps.offer.models.ApplicationResult``
            """
...
``izi.apps.offer.models.ApplicationResult``.  There are three subtypes
provided:
    
    * ``izi.apps.offer.models.BasketDiscount``. This takes an amount as it's
      constructor parameter.

    * ``izi.apps.offer.models.ShippingDiscount``. This indicates that the
      benefit affects the shipping charge.

    * ``izi.apps.offer.models.PostOrderAction``. This indicates that the
