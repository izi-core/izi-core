...
from izi.apps.customer.signals import user_registered
...
logger = logging.getLogger('izi.customer')
...
class RegisterUserMixin(object):
    ...
    def register_user(self, form):
        ...
        if getattr(settings, 'IZI_SEND_REGISTRATION_EMAIL', True):
        ...
        try:
            ...
            # twice, this is about the only place in IZI where we don't
