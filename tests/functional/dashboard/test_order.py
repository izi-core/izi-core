...
from izi.test.factories import PartnerFactory, ShippingAddressFactory
from izi.test.factories import create_order, create_basket
from izi.test.testcases import WebTestCase
from izi.test.factories import SourceTypeFactory
...
class TestOrderListSearch(WebTestCase):
    ...
    TEST_CASES = [
        ...
        (
            # Assumes that the test settings (IZI_ORDER_STATUS_PIPELINE)
...
class TestOrderDetailPage(WebTestCase):
    ...
    def test_allows_line_status_to_be_changed(self):
        ...
        self.assertEqual(line.status, settings.IZI_INITIAL_LINE_STATUS)
    ...
    def test_allows_order_status_to_be_changed(self):
        ...
        self.assertEqual(
            self.order.status, settings.IZI_INITIAL_ORDER_STATUS)
