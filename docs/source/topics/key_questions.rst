...
The design philosophy of IZI is to not make a decision for you here, but to
...
application.  Much of IZI's documentation is in the form of "recipes" that
...
need to capture the attributes of your product types within your models.  IZI
...
IZI provides classes for free shipping, fixed charge shipping, pre-order and
...
The checkout app within ``izi-core`` is suitably flexible that all of these
