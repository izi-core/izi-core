...
from izi.apps.address.models import Country
from izi.apps.checkout.forms import ShippingAddressForm
...
class TestShippingAddressForm(TestCase):
    ...
    @override_settings(IZI_REQUIRED_ADDRESS_FIELDS=('last_name', 'postcode'))
