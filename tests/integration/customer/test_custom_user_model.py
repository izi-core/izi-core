...
from izi.apps.customer.forms import ProfileForm
from izi.core.compat import existing_user_fields, get_user_model
from izi.test.factories.customer import ProductAlertFactory, UserFactory
