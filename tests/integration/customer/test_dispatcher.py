...
from izi.apps.customer.utils import Dispatcher, get_password_reset_url
from izi.apps.customer.models import CommunicationEventType, Email
from izi.apps.order.models import CommunicationEvent
from izi.test.factories import create_order, SiteFactory
