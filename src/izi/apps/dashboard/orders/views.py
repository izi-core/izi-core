...
from izi.apps.order import exceptions as order_exceptions
from izi.apps.payment.exceptions import PaymentError
from izi.core.compat import UnicodeCSVWriter
from izi.core.loading import get_class, get_model
from izi.core.utils import datetime_combine, format_datetime
...
class OrderListView(BulkEditMixin, ListView):
    ...
    def get_queryset(self):  # noqa (too complex (19))
        ...
        if data['name']:
            ...
            allow_anon = getattr(settings, 'IZI_ALLOW_ANON_CHECKOUT', False)
