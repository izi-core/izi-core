...
- Ensure the version is correctly set in izi.__init__.py
- Run: make release
"""
import os
import re
...
from izi import get_version  # noqa isort:skip
...
install_requires = [
    ...
    # Used for izi.test.newfactories
...
if len(sys.argv) > 1 and sys.argv[1] == 'develop':
    docs_url = 'https://izi-core.readthedocs.io/en/latest/internals/contributing/index.html'
    mailing_list = 'izi-core@googlegroups.com'
    mailing_list_url = 'https://groups.google.com/forum/?fromgroups#!forum/izi-core'
    twitter_url = 'https://twitter.com/django_izi'
    msg = (
        "You're installing IZI in 'develop' mode so I presume you're thinking\n"
        "of contributing:\n\n"
        ...
        "have a look at:\n    %s\n"
        "(d) Consider following @django_izi on Twitter to stay up-to-date\n"
