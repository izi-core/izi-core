...
from izi.apps.partner.importers import CatalogueImporter
from izi.apps.partner.exceptions import ImportingError
from izi.apps.catalogue.models import ProductClass, Product
from izi.apps.partner.models import Partner
