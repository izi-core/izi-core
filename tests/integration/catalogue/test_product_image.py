...
from izi.apps.catalogue.abstract_models import MissingProductImage
...
class TestMissingProductImage(StaticLiveServerTestCase):
    ...
    @mock.patch('izi.apps.catalogue.abstract_models.find')
    ...
    @mock.patch('izi.apps.catalogue.abstract_models.MissingProductImage.symlink_missing_image')
