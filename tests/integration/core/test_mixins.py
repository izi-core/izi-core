...
from izi.apps.address.forms import AbstractAddressForm
from izi.apps.address.models import UserAddress
from izi.apps.order.models import ShippingAddress
...
class PhoneNumberMixinTestCase(TestCase):
    ...
    @override_settings(IZI_REQUIRED_ADDRESS_FIELDS=('phone_number',))
    ...
    @override_settings(IZI_REQUIRED_ADDRESS_FIELDS=[])
