...
from izi.core.validators import non_python_keyword
from izi.models.fields import AutoSlugField, NullCharField
...
class AbstractCategory(MP_Node):
    ...
    def full_name(self):
        ...
        It's rarely used in IZI's codebase, but used to be stored as a
    ...
    def full_slug(self):
        ...
        IZI used to store this as in the 'slug' model field, but this field
    ...
    def save(self, *args, **kwargs):
        """
        IZI traditionally auto-generated slugs from names. As that is
...
class AbstractProduct(models.Model):
    ...
    # browsable property is deprecated and will be removed in IZI 2.1
    ...
    def is_review_permitted(self, user):
        ...
        Default implementation respects IZI_ALLOW_ANON_REVIEWS and only
        ...
        """
        if user.is_authenticated or settings.IZI_ALLOW_ANON_REVIEWS:
...
class AbstractProductAttributeValue(models.Model):
    ...
    value_file = models.FileField(
        upload_to=settings.IZI_IMAGE_FOLDER, max_length=255,
...
class MissingProductImage(object):
    ...
    into MEDIA_ROOT for convenience, as that is necessary every time an IZI
    ...
    def __init__(self, name=None):
        self.name = name if name else settings.IZI_MISSING_IMAGE_URL
    ...
    def symlink_missing_image(self, media_file_path):
        static_file_path = find('izi/img/%s' % self.name)
        if static_file_path is not None:
            try:
                ...
                raise ImproperlyConfigured((
                    ...
                    "This exception was raised because IZI was unable to "
...
class AbstractProductImage(models.Model):
    ...
    original = models.ImageField(
        _("Original"), upload_to=settings.IZI_IMAGE_FOLDER, max_length=255)
