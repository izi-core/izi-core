...
from izi.apps.customer.forms import generate_username
...
class GatewayView(generic.FormView):
    ...
    def form_valid(self, form):
        ...
        email = 'dashboard-user-%s@ecommerce.izi.asia' % username
    ...
    def send_confirmation_email(self, real_email, user, password):
        ...
        send_mail('Dashboard access to IZI sandbox',
                  msg, 'blackhole@latest.ecommerce.izi.asia',
                  [real_email])
