...
IZI has many views. This How-to describes how to customise one of them for
...
subclass IZI's view if you like::

    from izi.apps.promotions.views import HomeView as CoreHomeView
...
an app with the same name, it will get picked up automatically by IZI.
