...
.. automodule:: izi.apps.customer.abstract_models
    :members:

Forms
-----

.. automodule:: izi.apps.customer.forms
    :members:

Views
-----

.. automodule:: izi.apps.customer.views
    :members:
...
If the ``IZI_EAGER_ALERTS`` setting is ``True``, then alerts are sent as soon
as affected stock records are updated. Alternatively, the management command
``izi_send_alerts`` can be used to send alerts periodically.
