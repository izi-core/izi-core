...
from izi.test.factories.address import *  # noqa
from izi.test.factories.basket import *  # noqa
from izi.test.factories.catalogue import *  # noqa
from izi.test.factories.contrib import *  # noqa
from izi.test.factories.customer import *  # noqa
from izi.test.factories.models import *  # noqa
from izi.test.factories.offer import *  # noqa
from izi.test.factories.order import *  # noqa
from izi.test.factories.partner import *  # noqa
from izi.test.factories.payment import *  # noqa
from izi.test.factories.voucher import *  # noqa
from izi.test.factories.wishlists import *  # noqa
...
def create_stockrecord(product=None, price_excl_tax=None, partner_sku=None,
                       ...
                       currency=settings.IZI_DEFAULT_CURRENCY,
                       partner_users=None):
    if product is None:
