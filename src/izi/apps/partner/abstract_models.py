...
from izi.apps.partner.exceptions import InvalidStockAdjustment
...
class AbstractPartner(models.Model):
    ...
    setting up an IZI deployment. Many IZI deployments will only have one
    fulfillment partner.
    """
    ...
    def primary_address(self):
        ...
        if len(addresses) == 0:  # intentionally using len() to save queries
            ...
            raise NotImplementedError(
                "IZI's default implementation of primary_address only "
