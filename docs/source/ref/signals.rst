...
IZI implements a number of custom signals_ that provide useful hook-points
...
.. class:: izi.apps.catalogue.signals.product_viewed
...
.. class:: izi.apps.catalogue.signals.product_search
...
.. class:: izi.apps.customer.signals.user_registered
...
.. class:: izi.apps.basket.signals.basket_addition
...
.. class:: izi.apps.basket.signals.voucher_addition
...
.. class:: izi.apps.checkout.signals.start_checkout
...
.. class:: izi.apps.checkout.signals.pre_payment
...
.. class:: izi.apps.checkout.signals.post_payment
...
.. class:: izi.apps.order.signals.order_placed

   Raised by the :class:`izi.apps.order.utils.OrderCreator` class when
   creating an order.
...
.. class:: izi.apps.checkout.signals.post_checkout

    Raised by the :class:`izi.apps.checkout.mixins.OrderPlacementMixin` class
...
.. class:: izi.apps.catalogue.reviews.signals.review_added
