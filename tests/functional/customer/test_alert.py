...
from izi.apps.customer.alerts.utils import (
    send_alert_confirmation, send_product_alerts)
from izi.apps.customer.forms import ProductAlertForm
...
class TestAUserWithAnActiveStockAlert(WebTest):
    ...
    @mock.patch('izi.apps.customer.alerts.utils.services.notify_user')
...
class TestAlertMessageSending(TestCase):
    ...
    @mock.patch('izi.apps.customer.utils.Dispatcher.dispatch_direct_messages')
    ...
    @mock.patch('izi.apps.customer.utils.Dispatcher.dispatch_user_messages')
