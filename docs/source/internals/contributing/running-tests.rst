...
IZI uses pytest_ to run the tests.
...
When running a subset of tests, IZI uses the spec_ plugin.  It is a good
...
For example::
    ...
    rootdir: /Users/sasha0/projects/djangoizi, inifile: setup.cfg
