...
@override_settings(IZI_ALLOW_ANON_CHECKOUT=True)
...
class TestShippingMethodView(CheckoutMixin, WebTestCase):
    ...
    @mock.patch('izi.apps.checkout.views.Repository')
...
class TestPaymentDetailsView(CheckoutMixin, WebTestCase):
    ...
    @mock.patch('izi.apps.checkout.views.PaymentDetailsView.handle_payment')
    ...
    @mock.patch('izi.apps.checkout.views.logger')
    @mock.patch('izi.apps.checkout.views.PaymentDetailsView.handle_payment')
    ...
    @mock.patch('izi.apps.checkout.views.logger')
    @mock.patch('izi.apps.checkout.views.PaymentDetailsView.handle_order_placement')
