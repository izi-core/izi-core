...
ALLOWED_HOSTS = [
    'latest.ecommerce.izi.asia',
    'master.ecommerce.izi.asia',
    'localhost',
    '127.0.0.1',
]
...
# If you want to develop IZI's CSS, then set IZI_USE_LESS=True to enable the
...
THUMBNAIL_KEY_PREFIX = 'izi-sandbox'
