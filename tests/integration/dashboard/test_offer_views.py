...
from izi.apps.dashboard.offers import views as offer_views
from izi.apps.dashboard.ranges import views as range_views
from izi.core.loading import get_model
from izi.test.factories import catalogue, offer
