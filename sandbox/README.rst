...
http://latest.ecommerce.izi.asia
-------------------------------

This is a vanilla install of IZI with as little customisation as possible to
...
* A "gateway" page that lets users create a dashboard user so they can play with
  the dashboard.
* A profile model with a few fields, designed to test IZI's account section
  which should automatically allow the profile fields to be edited.

It is deployed automatically to: http://latest.ecommerce.izi.asia
