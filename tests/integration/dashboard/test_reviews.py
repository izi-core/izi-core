...
from izi.apps.dashboard.reviews import views
from izi.core.loading import get_model
from izi.test.factories.catalogue import ProductReviewFactory
from izi.test.factories.customer import UserFactory
