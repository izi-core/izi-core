...
IZI ships with a powerful and flexible offers engine which is contained in the
...
IZI's dashboard can be used to administer offers.
...
exist in core IZI but can be implemented using the 'accounts' plugin).
...
.. automodule:: izi.apps.offer.abstract_models
    :members:

Models
-------

.. automodule:: izi.apps.offer.models
    :members:

Views
-----

.. automodule:: izi.apps.offer.views
    :members:
