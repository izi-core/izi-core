# -*- coding: utf-8 -*-
#
# izi-core documentation build configuration file, created by
...
from izi import get_version, get_short_version
version = get_version()
...
issues_github_path = 'izi-core/izi-core'
...
latex_documents = [
  ('index', 'izi-core.tex', 'izi-core Documentation',
...
man_pages = [
    ('index', 'izi-core', 'izi-core Documentation',
