...
from izi.apps.checkout.calculators import OrderTotalCalculator
from izi.apps.checkout.mixins import CheckoutSessionMixin, OrderPlacementMixin
from izi.apps.checkout.exceptions import FailedPreCondition
from izi.core.loading import get_model
from izi.test import factories
from izi.test.basket import add_product
from izi.test.utils import RequestFactory
