...
IZI is a just a set of Django apps - it doesn't have any special deployment
...
gained from running IZI projects.

Performance
-----------

Setting up caching is crucial for a good performance. IZI's templates are
...
IZI relies on the Django framework for security measures and therefore no
IZI specific configurations with regard to security are in place. See
...
A basic example of what a sitemap for IZI could look like has been added
