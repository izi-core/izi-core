...
from izi.apps.order.exceptions import (
...
from izi.apps.order.signals import order_line_status_changed, order_status_changed
from izi.test.basket import add_product
from izi.test.contextmanagers import mock_signal_receiver
...
class OrderTests(TestCase):
    ...
    @mock.patch('izi.apps.order.abstract_models.now')
    ...
    @override_settings(IZI_DEPRECATED_ORDER_VERIFY_KEY='deprecated_order_hash_secret')
    ...
    @override_settings(
        IZI_DEPRECATED_ORDER_VERIFY_KEY='deprecated_order_hash_secret',
